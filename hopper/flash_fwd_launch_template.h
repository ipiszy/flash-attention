...
void run_flash_fwd(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    >;
    using CollectiveEpilogue = flash::CollectiveEpilogueFwd<TileShape_MNK, ClusterShape, ElementOut, ArchTag, CollectiveMainloop::NumMmaThreads, Varlen, PackGQA, FP8_TransposeV, TileShape_MNK_VO>;
