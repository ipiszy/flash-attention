...
template <int kStages, class Gemm1Type, class Gemm2Type, class OutputType,
          class SmemLayoutQ, class SmemLayoutK, class SmemLayoutV,
          class SmemLayoutO>
...
template <int kHeadDimQK_, int kHeadDimVO_, int kBlockM_, int kBlockN_,
          int kNWarps_, int kStages_, bool Is_Q_in_regs_ = false,
...
struct Flash_fwd_kernel_traits {
  ...
  static_assert(kNWarps_ == 4 || kNWarps_ == 8 || kNWarps_ == 12 ||
                kNWarps_ == 16);
  static constexpr bool Is_WS = kNWarps_ >= 12;
  static_assert(!(Is_WS && Is_Q_in_regs),
                "Warp-specialization does not support Q in registers");

  static constexpr int kBlockM = kBlockM_;
  static constexpr int kBlockN = kBlockN_;
  static constexpr int kHeadDimQK = kHeadDimQK_;
  static constexpr int kHeadDimVO = kHeadDimVO_;
  static_assert(kHeadDimQK % 32 == 0);
  static_assert(kHeadDimVO % 32 == 0);
  using TileShape_MNK_QK = Shape<Int<kBlockM>, Int<kBlockN>, Int<kHeadDimQK>>;
  ...
  using TiledMma1 = decltype(cute::make_tiled_mma(
      cute::GMMA::rs_op_selector<Element, Element, ElementAccum,
                                 decltype(select<0, 2, 1>(TileShape_MNK_VO{})),
  ...
  using SmemLayoutK = decltype(tile_to_shape(
      SmemLayoutAtomK{},
      make_shape(shape<1>(TileShape_MNK_QK{}), shape<2>(TileShape_MNK_QK{}),
                 Int<kStages>{})));
  ...
  using SmemLayoutV = decltype(tile_to_shape(
      SmemLayoutAtomV{},
      make_shape(get<1>(TileShape_MNK_VO{}), get<2>(TileShape_MNK_VO{}),
                 Int<kStages>{})));

  // Note this is the transpose in terms of the view, not in terms of memory.
  using SmemLayoutVt = decltype(composition(
      SmemLayoutV{}, make_ordered_layout(make_shape(get<2>(TileShape_MNK_VO{}),
                                                    get<1>(TileShape_MNK_VO{}),
                                                    Int<kStages>{}),
                                         Step<_2, _1, _3>{})));

  using SmemLayoutAtomO =
      decltype(cutlass::gemm::collective::detail::ss_smem_selector<
               GMMA::Major::K, OutputType,
  ...
  using SharedStorage =
      SharedStorageQKVO<kStages, Element, Element, Element, SmemLayoutQ,
...
struct Flash_fwd_kernel_traits_fp8 {
  ...
  static constexpr int kHeadDimQK = kHeadDim_;
  static constexpr int kHeadDimVO = kHeadDim_;
  static_assert(kHeadDim % 32 == 0);
  using TileShape_MNK = Shape<Int<kBlockM>, Int<kBlockN>, Int<kHeadDim>>;
  using TileShape_MNK_QK = TileShape_MNK;
  using TileShape_MNK_VO = TileShape_MNK;
  ...
  using FactoringShapeV = decltype(make_shape(
      SmemShapeLDSM{}, shape<1>(SmemLayoutDivideV{}),
  ...
  using SmemLayoutVtTrans = decltype(composition(
      SmemLayoutVt{}, make_ordered_layout(product_each(shape(SmemLayoutV{})),
                                          Step<_2, _1, _3>{})));
  ...
  using FactoringShapeVt = decltype(make_shape(
      SmemShapeSTSM{}, shape<1>(SmemLayoutDivideVt{}),
  ...
  using TiledCopyrO =
      decltype(make_tiled_copy(Copy_Atom<UniversalCopy<uint16_t>, OutputType>{},
  ...
  using SharedStorage =
      SharedStorageQKVOVt<kStages, Element, Element, OutputType, SmemLayoutQ,
                          SmemLayoutK, SmemLayoutV, SmemLayoutO>;
...
template <bool Has_P_smem, int kStages, class Element, class OutputType,
          class SmemLayoutQ, class SmemLayoutdO, class SmemLayoutK,
          class SmemLayoutV, class SmemLayoutP, class SmemLayoutdS,
          class SmemLayoutdK, class SmemLayoutdV>
struct SharedStorageQKVdOdKV;

template <int kStages, class Element, class OutputType, class SmemLayoutQ,
          class SmemLayoutdO, class SmemLayoutK, class SmemLayoutV,
          class SmemLayoutP, class SmemLayoutdS, class SmemLayoutdK,
          class SmemLayoutdV>
struct SharedStorageQKVdOdKV<
    true, kStages, Element, OutputType, SmemLayoutQ, SmemLayoutdO, SmemLayoutK,
    SmemLayoutV, SmemLayoutP, SmemLayoutdS, SmemLayoutdK, SmemLayoutdV> {
  struct {
...
template <int kStages, class Element, class OutputType, class SmemLayoutQ,
          ...
          class SmemLayoutdV>
struct SharedStorageQKVdOdKV<
    false, kStages, Element, OutputType, SmemLayoutQ, SmemLayoutdO, SmemLayoutK,
    SmemLayoutV, SmemLayoutP, SmemLayoutdS, SmemLayoutdK, SmemLayoutdV> {
  struct {
    cute::array_aligned<Element, cute::cosize_v<SmemLayoutQ>> smem_q;
    cute::array_aligned<Element, cute::cosize_v<SmemLayoutdO>> smem_do;
    ...
    union { // Put smem_p in a union just so we can still refer to it in the
            // struct, even if it's not used.
      cute::array_aligned<Element, cute::cosize_v<SmemLayoutP>> smem_p;
      cute::array_aligned<Element, cute::cosize_v<SmemLayoutdS>> smem_ds;
    };
  };
...
template <int kStages, class Element, class OutputType, class SmemLayoutQ,
          class SmemLayoutdO, class SmemLayoutK, class SmemLayoutV,
          class SmemLayoutP, class SmemLayoutdS, class SmemLayoutdQacc,
          class SmemLayoutdK, class SmemLayoutdV>
struct SharedStorageQKVdOdKVWS<true, kStages, Element, OutputType, SmemLayoutQ,
                               SmemLayoutdO, SmemLayoutK, SmemLayoutV,
                               SmemLayoutP, SmemLayoutdS, SmemLayoutdQacc,
...
template <int kStages, class Element, class OutputType, class SmemLayoutQ,
          ...
          class SmemLayoutP, class SmemLayoutdS, class SmemLayoutdQacc,
          class SmemLayoutdK, class SmemLayoutdV>
struct SharedStorageQKVdOdKVWS<false, kStages, Element, OutputType, SmemLayoutQ,
                               SmemLayoutdO, SmemLayoutK, SmemLayoutV,
                               SmemLayoutP, SmemLayoutdS, SmemLayoutdQacc,
                               SmemLayoutdK, SmemLayoutdV> {
  struct {
...
template <int kStages, class Element, class OutputType, class SmemLayoutQ,
          class SmemLayoutdO, class SmemLayoutK, class SmemLayoutV,
          class SmemLayoutP, class SmemLayoutdS, class SmemLayoutdQ>
struct SharedStorageQKVdOdKVSeqqPar<
    true, kStages, Element, OutputType, SmemLayoutQ, SmemLayoutdO, SmemLayoutK,
    SmemLayoutV, SmemLayoutP, SmemLayoutdS, SmemLayoutdQ> {
  struct {
    cute::array_aligned<Element, cute::cosize_v<SmemLayoutK>> smem_k;
    cute::array_aligned<Element, cute::cosize_v<SmemLayoutV>> smem_v;
    union {
...
template <int kHeadDimQK_, int kHeadDimVO_, int kBlockM_, int kBlockN_,
          int kNWarps_, bool SdP_swapAB_, bool dKV_swapAB_, bool dQ_swapAB_,
...
struct Flash_bwd_kernel_traits {
  ...
  using TileShapeAtomSdP = std::conditional_t<
      !SdP_swapAB,
      Shape<Int<kBlockM>, Int<kBlockN / (2 / AtomLayoutMSdP)>, Int<kHeadDimQK>>,
      Shape<Int<kBlockN / (2 / AtomLayoutMSdP)>, Int<kBlockM>,
            Int<kHeadDimQK>>>;
  ...
  using TileShapeAtomdKV = std::conditional_t<
      !dKV_swapAB,
      Shape<Int<kBlockN>, Int<kHeadDimVO / (2 / AtomLayoutNdKV)>, Int<kBlockM>>,
      Shape<Int<kHeadDimVO / (2 / AtomLayoutNdKV)>, Int<kBlockN>,
            Int<kBlockM>>>;
  ...
  using TileShapeAtomdQ = std::conditional_t<
      !dQ_swapAB,
      Shape<Int<kBlockM>, Int<kHeadDimQK / (2 / AtomLayoutMdQ)>, Int<kBlockN>>,
      Shape<Int<kHeadDimQK / (2 / AtomLayoutMdQ)>, Int<kBlockM>, Int<kBlockN>>
      // Shape<Int<kBlockM>, Int<kHeadDim >, Int<kBlockN>>,
      // Shape<Int<kHeadDim>, Int<kBlockM>, Int<kBlockN>>
      >;
  using AtomLayoutdQ = std::conditional_t<
      !dQ_swapAB, Layout<Shape<Int<AtomLayoutMdQ>, Int<2 / AtomLayoutMdQ>, _1>>,
  ...
  using GmemTiledCopyQdO = decltype(cutlass::gemm::collective::detail::
  ...
  using Gmem_copy_struct = std::conditional_t<
      Has_cp_async, SM80_CP_ASYNC_CACHEGLOBAL<cute::uint128_t>, DefaultCopy>;
  static constexpr int kBlockKSmem = kHeadDimQK % 64 == 0 ? 64 : 32;
  static constexpr int kGmemElemsPerLoad =
      sizeof(cute::uint128_t) / sizeof(Element);
  static_assert(kHeadDimQK % kGmemElemsPerLoad == 0,
  ...
  using GmemLayoutAtom = Layout<
      Shape<Int<kNThreadsNonWS / kGmemThreadsPerRow>, Int<kGmemThreadsPerRow>>,
      Stride<Int<kGmemThreadsPerRow>, _1>>;
  using GmemLayoutAtomdQ = Layout<
  ...
  using GmemTiledCopydQ = decltype(make_tiled_copy(
      Copy_Atom<DefaultCopy, elem_type>{}, GmemLayoutAtomdQ{},
      Layout<Shape<_1, _8>>{})); // Val layout, 8 vals per store
  using GmemLayoutAtomdQaccum = std::conditional_t<
      kBlockKSmem == 32,
      Layout<Shape<Int<kNThreadsdQ / 8>, _8>, // Thread layout, 8 threads per
                                              // row
             Stride<_8, _1>>,
      Layout<Shape<Int<kNThreadsdQ / 16>, _16>, // Thread layout, 16 threads per
                                                // row
             Stride<_16, _1>>>;
  using GmemTiledCopydQaccum = decltype(make_tiled_copy(
      Copy_Atom<DefaultCopy, ElementAccum>{}, GmemLayoutAtomdQaccum{},
  ...
  using SmemLayoutQ = decltype(tile_to_shape(
      SmemLayoutAtomQ{},
      make_shape(shape<0>(TileShape_MNK_QK{}), shape<2>(TileShape_MNK_QK{}),
                 Int<kStages>{})));
  ...
  using SmemLayoutAtomP =
      decltype(cutlass::gemm::collective::detail::ss_smem_selector<
               ...
               decltype(cute::get<0>(TileShape_MNK_QK{})),
               decltype(cute::get<1>(TileShape_MNK_QK{}))>());
  using SmemLayoutP = decltype(tile_to_shape(SmemLayoutAtomP{},
  ...
  using SmemLayoutdS = decltype(tile_to_shape(
      SmemLayoutAtomdS{}, select<0, 1>(TileShape_MNK_QK{})));

  // using SmemLayoutAtomdQacc =
  // decltype(cutlass::gemm::collective::detail::ss_smem_selector<GMMA::Major::K,
  // ElementAccum,
  //     decltype(cute::get<0>(TileShape_MNK{})),
  //     decltype(cute::get<2>(TileShape_MNK{}))>());
  // using SmemLayoutdQacc = decltype(tile_to_shape(SmemLayoutAtomdQacc{},
  ...
  using SmemLayoutQt = decltype(cute::composition(
      SmemLayoutQ{},
      make_layout(
          make_shape(get<2>(TileShape_MNK_QK{}), get<0>(TileShape_MNK_QK{}),
                     Int<kStages>{}),
          make_stride(Int<kBlockM>{}, _1{}, Int<kBlockM * kHeadDimQK>{}))));
  ...
  using SmemLayoutKt = decltype(cute::composition(
      SmemLayoutK{}, make_layout(make_shape(get<2>(TileShape_MNK_QK{}),
                                            get<1>(TileShape_MNK_QK{})),
                                 make_stride(Int<kBlockN>{}, _1{}))));
  using SmemLayoutPt = decltype(cute::composition(
      SmemLayoutP{}, make_layout(make_shape(get<1>(TileShape_MNK_QK{}),
                                            get<0>(TileShape_MNK_QK{})),
                                 make_stride(Int<kBlockM>{}, _1{}))));
  using SmemLayoutdSt = decltype(cute::composition(
      SmemLayoutdS{}, make_layout(make_shape(get<1>(TileShape_MNK_QK{}),
                                             get<0>(TileShape_MNK_QK{})),
                                  make_stride(Int<kBlockM>{}, _1{}))));
  ...
  using SmemLayoutdQ = decltype(tile_to_shape(
      SmemLayoutAtomdQ{}, make_shape(Int<kBlockM>{}, Int<kHeadDimQK>{})));
  using SmemLayoutdQt = decltype(cute::composition(
      SmemLayoutdQ{}, make_layout(make_shape(get<2>(TileShape_MNK_QK{}),
                                             get<0>(TileShape_MNK_QK{})),
                                  make_stride(Int<kBlockM>{}, _1{}))));
  ...
  using SmemLayoutAtomdQaccTMA =
      decltype(cutlass::gemm::collective::detail::ss_smem_selector<
               GMMA::Major::K, ElementAccum,
               decltype(cute::get<0>(TileShape_MNK_QK{})),
               decltype(cute::get<1>(TileShape_MNK_QK{}))>());
  using SmemLayoutdQaccTMA = decltype(tile_to_shape(
      SmemLayoutAtomdQaccTMA{}, select<0, 2>(TileShape_MNK_QK{})));
  using SmemLayoutdQacc = SmemLayoutdQ;
  using SmemLayoutdQacct = SmemLayoutdQt;
  using SmemLayoutdQacc2 = decltype(tile_to_shape(
      SmemLayoutAtomdQ{}, make_shape(Int<kBlockM>{}, Int<kHeadDimQK>{}, _2{})));
  // using SmemLayoutdQacc = decltype(tile_to_shape(SmemLayoutAtomdQacc{},
  // select<0, 2>(TileShape_MNK{}))); using SmemLayoutdQacct =
  //     decltype(cute::composition(SmemLayoutdQacc{},
  //                                make_layout(make_shape(get<2>(TileShape_MNK{}),
  //                                get<0>(TileShape_MNK{})),
  //                                            make_stride(Int<kBlockM>{},
  //                                            _1{}))));
  using RmemTiledCopydQacc = decltype(make_tiled_copy(
      Copy_Atom<DefaultCopy, ElementAccum>{}, GmemLayoutAtomdQaccum{},
      Layout<Shape<_1, _4>>{})); // Val layout, 4 vals per store
  ...
  using SmemCopyAtomdQ =
      Copy_Atom<std::conditional_t<!dQ_swapAB, cute::SM90_U32x4_STSM_N,
                                   cute::SM90_U16x8_STSM_T>,
                Element>;

  using SharedStorage = std::conditional_t<
      !Is_WS,
      SharedStorageQKVdOdKV<!SdP_swapAB, kStages, Element, Element, SmemLayoutQ,
                            SmemLayoutdO, SmemLayoutK, SmemLayoutV, SmemLayoutP,
                            SmemLayoutdS, SmemLayoutdK, SmemLayoutdV>,
      SharedStorageQKVdOdKVWS<!SdP_swapAB, kStages, Element, Element,
                              SmemLayoutQ, SmemLayoutdO, SmemLayoutK,
                              SmemLayoutV, SmemLayoutP, SmemLayoutdS,
                              SmemLayoutdQacc, SmemLayoutdK, SmemLayoutdV>
      // SmemLayoutK, SmemLayoutV, SmemLayoutdS, SmemLayoutdQacc2, SmemLayoutdK,
      // SmemLayoutdV>
      >;
...
struct Flash_bwd_seqqpar_kernel_traits {
  ...
  using SmemLayoutdKt = SmemLayoutKt;
  using SmemLayoutdVt = SmemLayoutKt;
  using SmemLayoutdQTMA =
      decltype(tile_to_shape(SmemLayoutAtomK{}, select<0, 2>(TileShape_MNK{})));
  ...
  using SmemLayoutdQ = decltype(tile_to_shape(
      SmemLayoutAtomdQ{}, make_shape(Int<kBlockM>{}, Int<kHeadDim>{})));
  using SmemLayoutdQt = decltype(cute::composition(
      SmemLayoutdQ{},
      make_layout(make_shape(get<2>(TileShape_MNK{}), get<0>(TileShape_MNK{})),
                  make_stride(Int<kBlockM>{}, _1{}))));
  ...
  using SmemLayoutdKV = decltype(tile_to_shape(
      SmemLayoutAtomdKV{}, make_shape(Int<kBlockN>{}, Int<kHeadDim>{})));
  using SmemLayoutdKVt = decltype(cute::composition(
      SmemLayoutdKV{},
      make_layout(make_shape(get<2>(TileShape_MNK{}), get<1>(TileShape_MNK{})),
                  make_stride(Int<kBlockN>{}, _1{}))));
  static constexpr int kSmemdKVSize =
      size(SmemLayoutdKV{}) * sizeof(Element) * 2;
  ...
  using SharedStorage = SharedStorageQKVdOdKVSeqqPar<
      !SdP_swapAB, kStages, Element, Element, SmemLayoutQ, SmemLayoutdO,
